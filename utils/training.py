...
import warnings
import numpy as np
from xgboost.core import Booster, STRING_TYPES, XGBoostError, CallbackEnv, EarlyStopException
from xgboost.compat import (SKLEARN_INSTALLED, XGBStratifiedKFold)
...
def mknfold(dall, nfold, param, seed, evals=(), fpreproc=None, stratified=False,
    ...
    for k in range(nfold):
        ...
        dtrain.feature_names = dall.feature_names
        dtest = dall.slice(idset[k])
        dtest.feature_names = dall.feature_names
